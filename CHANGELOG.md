...
## [0.2.4](https://github.com/surrealdb-dev/surql-jetbrains/compare/v0.2.3...v0.2.4) - 2026-07-07

### Fixed

- Syntax highlighting now recognises the SurrealQL `.?` optional chaining
  operator.

## [0.2.3](https://github.com/surrealdb-dev/surql-jetbrains/compare/v0.2.2...v0.2.3) - 2026-06-01

### Fixed

- Number syntax highlighting now recognises underscore separators
  (e.g. `1_000_000`), scientific notation (e.g. `1.5e-3`), and `f`-suffixed
  float literals as distinct from integers. Duration literals with underscores
  (e.g. `1_000ms`) are highlighted correctly as well.

## [0.2.2](https://github.com/surrealdb-dev/surql-jetbrains/compare/v0.2.1...v0.2.2) - 2026-05-20

### Added

- `async` keyword support in `DEFINE EVENT` statements (syntax highlighting and
